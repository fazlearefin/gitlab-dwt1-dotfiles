...
The Xmonad Config (.xmonad/xmonad.hs) maps Control-S to a scratchpad. If you do not use Vim or Emacs, then you may benefit from remapping the keys in *~/.xmonad/xmonad.hs*.
